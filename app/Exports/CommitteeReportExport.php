...
class CommitteeReportExport implements FromCollection, WithHeadings, WithTitle
{
    ...
    {
        return ['ID', 'Candidato', 'Modalidade', 'Título do projeto', 'NMA', 'NP', 'NC', 'Justificativa do comitê', 'Status', 'Reprovado', 'Atualização'];
    }
