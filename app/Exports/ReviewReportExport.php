...
class ReviewReportExport implements FromCollection, WithHeadings, WithTitle
{
    ...
    {
        return ['ID', 'Candidato', 'Modalidade', 'Título do projeto', 'Avaliadores', 'Media da avaliação', 'Status', 'Reprovado', 'Atualização'];
    }
