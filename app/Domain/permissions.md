...
committee.manage             # Gerenciar bancas examinadoras. (Administrator)
committee.assign-members     # Definir os membros de cada banca. (Administrator)
...
committee.finalize           # Encerrar a etapa de avaliação da banca. (Administrator)
