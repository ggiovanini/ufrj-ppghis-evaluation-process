...
const recalculateAllResults = () => {
    openConfirmation(
        ...
        'Tem certeza que deseja recalcular todas as notas finais desta seleção?',
        () => {
            router.post(
                selectionRoutes.results.recalculate(props.selection.id).url,
            );
        },
        'Recalcular notas',
        'default',
...
const finalize = () => {
    openConfirmation(
        ...
        'Tem certeza que deseja finalizar os resultados e encerrar esta seleção?',
        () => {
...
const isFullyCalculated = computed(() => {
    return props.stats.final_results === props.stats.final_resulted;
});
</script>
                ...
                <div class="flex items-center gap-2">
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" class="w-56">
                            <DropdownMenuItem @click="recalculateAllResults">
                    ...
                    <Button @click="finalize" :disabled="!isFullyCalculated">
